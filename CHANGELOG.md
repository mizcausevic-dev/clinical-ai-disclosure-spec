...
### Released
- Released **clinical-ai-disclosure-spec** publicly as a reviewable operating system for answer-engine visibility.
...
### Shipped
- Cut the first coherent internal version of **clinical-ai-disclosure-spec** with stable domain objects, review surfaces, and decision outputs.
